...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_faridlan_omni-library-api_internal_delivery_http_dto.ForgotPasswordRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Jika email valid, link akan dikirim",
                        "schema": {
        ...
        "/api/auth/login": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Login berhasil, berisi access_token dan refresh_token",
                        "schema": {
                            "$ref": "#/definitions/github_com_faridlan_omni-library-api_internal_utils.SuccessResponse-github_com_faridlan_omni-library-api_internal_delivery_http_dto_TokenResponse"
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_faridlan_omni-library-api_internal_utils.SuccessResponse-github_com_faridlan_omni-library-api_internal_delivery_http_dto_UserResponse"
                        }
                    },
                    "400": {
                        "description": "Format JSON salah atau validasi gagal",
        ...
        "/api/auth/reset-password": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Payload token dan password baru",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_faridlan_omni-library-api_internal_delivery_http_dto.ResetPasswordRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/library/{user_book_id}/notes/{note_id}": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_faridlan_omni-library-api_internal_delivery_http_dto.UpdateNoteRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "404": {
                        "description": "Note buku tidak ditemukan",
                        "schema": {
                            "$ref": "#/definitions/github_com_faridlan_omni-library-api_internal_utils.ErrorResponse"
                        }
                    },
    ...
    "definitions": {
        ...
        "github_com_faridlan_omni-library-api_internal_delivery_http_dto.ForgotPasswordRequest": {
            "type": "object",
            "required": [
                "email"
            ],
        ...
        "github_com_faridlan_omni-library-api_internal_delivery_http_dto.ResetPasswordRequest": {
            "type": "object",
            "required": [
                "confirm_password",
                "new_password",
        ...
        "github_com_faridlan_omni-library-api_internal_utils.SuccessResponse-github_com_faridlan_omni-library-api_internal_delivery_http_dto_TokenResponse": {
            "type": "object",
            "properties": {
                "data": {
        ...
        "github_com_faridlan_omni-library-api_internal_utils.SuccessResponse-github_com_faridlan_omni-library-api_internal_delivery_http_dto_UserResponse": {
            "type": "object",
            "properties": {
                "data": {
