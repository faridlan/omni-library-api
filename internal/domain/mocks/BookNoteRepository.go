...
// FindAllByUserBookID provides a mock function with given fields: ctx, userBookID, params
func (_m *BookNoteRepository) FindAllByUserBookID(ctx context.Context, userBookID string, params domain.PaginationQuery) ([]*domain.BookNote, int64, error) {
	ret := _m.Called(ctx, userBookID, params)

	if len(ret) == 0 {
		panic("no return value specified for FindAllByUserBookID")
	}
...
// FindByID provides a mock function with given fields: ctx, noteID
func (_m *BookNoteRepository) FindByID(ctx context.Context, noteID string) (*domain.BookNote, error) {
	ret := _m.Called(ctx, noteID)
